            ...
            <div className="dz-card style-5">
              ...
              <div className="dz-info">
                <ul className="dz-category">
                  <li>
                    <Link to={"#"}>{d.subtitle}</Link>
                  </li>
                </ul>
                <h5 className="dz-title">
                  <Link to={"/fundraiser-detail"}>{d.title} </Link>
                </h5>
                ...
                <div className="progress-bx style-2">
                  ...
                  <ul className="progress-tag">
                    <li className="raised">
                      Raised: <span className="text-primary">$ 5,345</span>
                    </li>
                    <li className="goal">
                      Goal: <span className="text-primary">$70,000</span>
                    </li>
                  </ul>
                </div>
              </div>
