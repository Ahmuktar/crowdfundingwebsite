    ...
    <>
        ...
        >
          ...
          <div className="col-md-4 col-sm-4 col-3">
            <div className="swiper-btn float-sm-end m-b40">
              <div
                className="test-swiper-prev btn-prev text-white"
                ref={navigationPrevRef}
              >
                <i className="flaticon-left-arrow-1"></i>
              </div>
              <div
                className="test-swiper-next btn-next text-white"
      ...
      <div className="resize-wrapper">
              ...
              <div className="testimonial-3">
                ...
                <div className="testimonial-content">
                  <h5 className="testimonial-title">
                    Heroes like you helped my son
                    <br /> win his battle.
                  </h5>
                  <p className="testimonial-text">
                    There are many variations of passages of Lorem Ipsum
                    available, but the majority have suffered alteration in some
                    form, or randomised words which{" "}
        ...
        <Link
          ...
          className="btn btn-primary m-r15 m-b15 "
        >
